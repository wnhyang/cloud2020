...
B站：[https://www.bilibili.com/video/BV18E411x7eT](https://www.bilibili.com/video/BV18E411x7eT)
...
![xxx](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/xxx.62z8ohvtzd40.svg)
...
![xxx](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/xxx.1erwgq374j34.png)
...
![img](https://img-blog.csdnimg.cn/img_convert/fc8ed10fca5f7cc56e4d4623a39245eb.png)

## 技术选型

![xxx](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/xxx.4dt6x07jup60.png)
...
工具 IDEA + Chrome（推荐 JSONView插件）+ VSCode + Navicat Premium + RedisDesktopManager + VM（Centos7）+ MobaXterm + Postman + JMeter
...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <groupId>com.wnh.springcloud</groupId>
...
A[客户端消费者80 order <>] --> B[微服务提供者8001 payment <>]
...
mybatis:
  ...
  type-aliases-package: com.wnh.springcloud.entities    # 所有Entity别名类所在包
```
...
<mapper namespace="com.wnh.springcloud.dao.PaymentDao">
    ...
    <resultMap id="BaseResultMap" type="com.wnh.springcloud.entities.Payment">
...
* Postman - http://localhost:8001/payment/create?serial=wnh
...
浏览器 - http://localhost/consumer/payment/create?serial=zs

虽然，返回成功，但是观测数据库中，并没有创建`serial`为`zs`的行。
...
![xxx](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/xxx.5l6qdoglsjo0.png)
...
![xxx](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/xxx.2zz6enr3lac0.png)
...
创建cloud-eureka-server7002工程，过程参考[EurekaServer服务端安装](https://blog.csdn.net/u011863024/article/details/114298270#)

```mermaid
graph LR

A[Eureka 7001<>] --> B[Eureka 7002<>]
...
**相互注册，相互守望**
![xxx](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/xxx.5xb0ypg5fd80.png)
...
![xxx](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/xxx.1b8aj0b9gcg0.png)
...
spring:
  ...
  cloud:
    zookeeper:
      connect-string: 192.168.124.123:2181 # 192.168.124.123:2181 #
```
...
![xxx](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/xxx.4zoba59jmvo0.png)
...
![xxx](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/xxx.5vrvxgyu8b80.png)
...
![145b915e56a85383b3ad40f0bb2256e0](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/145b915e56a85383b3ad40f0bb2256e0.3hyhaisqq3w0.png)
...
![87243c00c0aaea211819c0d8fc97e445](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/87243c00c0aaea211819c0d8fc97e445.gma762s6iy8.png)
...
4、在com.wnh.myrule下新建MySelfRule规则类
...
返回结果中的serverPort在8001与8002两种间轮询
...
3、MyLB 实现LoadBalancer接口（回到包扫描下）
...
5、测试 不停地刷新http://localhost/consumer/payment/lb，可以看到8001/8002轮询
...
![xxx](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/xxx.367ksd94p640.png)
...
![xxx](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/xxx.exc0zefxk48.png)
...
![xxx](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/xxx.2c36ylp73pjw.png)
...
![xxx](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/xxx.1wc1gqzzq134.png)
...
![xxx](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/xxx.3kiqohfx72w0.png)



- 整图说明2

![xxx](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/xxx.3evev6ekea80.png)
...
![xxx](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/xxx.bz3ahtzjwns.png)
...
![xxx](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/xxx.udgil7frbm8.png)
...
![xxx](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/xxx.33yql3c1sc00.png)
...
![xxx](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/xxx.3nik4q0awm20.png)
...
默认情况下Gateway会根据注册中心注册的服务列表，以注册中心上微服务名为路径**创建动态路由进行转发，从而实现动态路由的功能**（不写死一个地址）。
...
# 带cookie的
curl http://localhost:9527/payment/lb --cookie "username=zs"
```
...
![xxx](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/xxx.j9edsx6dgvs.png)
...
spring:
  ...
  cloud:
    config:
      server:
        git:
          uri: git@gitee.com:wnhyang/springcloud-config.git #GitHub（Gitee）上面的git仓库名字
          # ssh不行就用https，配置本地的不用用户名，密码
...
![xxx](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/xxx.p8qng92qdi8.png)
...
![xxx](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/xxx.ckuo5vxchq0.png)
...
![xxx](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/xxx.713kv4vhn5c0.png)

2、利用消息总线触发一个服务端ConfigServer的/bus/refresh端点，而刷新所有客户端的配置

![xxx](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/xxx.1lpiafh2oin4.png)
...
![xxx](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/xxx.5gywg2dqx7g0.png)
...
![dd57e502418ecdae99f29991abe8bb02](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/dd57e502418ecdae99f29991abe8bb02.7jfhgzvbj2c0.png)
...
![5587b05def1c26b8c9d9874c78f80b28](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/5587b05def1c26b8c9d9874c78f80b28.2d5w12wev1xc.png)
...
![96256569e677453570b55209c26e0b8c](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/96256569e677453570b55209c26e0b8c.55gd8pexti00.png)
...
![077a3b34aec6eed91a7019a9d5ca4e3c](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/077a3b34aec6eed91a7019a9d5ca4e3c.3g5ziej3yws0.png)

![1ca02dd31581d92a7a610bcd137f6848](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/1ca02dd31581d92a7a610bcd137f6848.1fbd8kft7cs.png)
...
![f61e83441af907a42e8886368bde59ff](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/f61e83441af907a42e8886368bde59ff.1nq6a4pgi9ts.png)
...
**不同的组**是可以重复消费的，**同一个组**内会发生竞争关系，只有其中一个可以消费。（通过查看 RabbitMQ web控制台，查看分组和交换机）
...
8803修改yml（与8802的类似位置 `group: Group_B`）
...
停止8802/8803并**去除掉**8802的分组`group: Group_A`，8803的分组`group: Group_A`没有去掉。
...
![b40478e2b2c83d7181b9c71cdcae05ea](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/b40478e2b2c83d7181b9c71cdcae05ea.2cf3vc5gy2o0.png)

![f97d15b5686264d45b46f6f188e99873](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/f97d15b5686264d45b46f6f188e99873.59gf56ms6f40.png)
...
![ca541262b26f809a0c25014feaa069d7](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/ca541262b26f809a0c25014feaa069d7.4wsj5w9msq60.png)
...
+ https://dl.bintray.com/openzipkin/maven/io/zipkin/java/zipkin-server/（不能使用，用下面的）
...
![ec45d9d026fee8c83eaaf7bf8cb6893d](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/ec45d9d026fee8c83eaaf7bf8cb6893d.3eeh6dfs80o0.png)

—条链路通过Trace ld唯一标识，Span标识发起的请求信息，各span通过parent id关联起来。



![f75fcfd2146df03428b9c8c53d13c1f1](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/f75fcfd2146df03428b9c8c53d13c1f1.bslca56sznk.png)

整个链路的依赖关系如下：



![c1d19c5e9724578ee9c8668903685fa4](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/c1d19c5e9724578ee9c8668903685fa4.5tju32opey80.png)
...
![2bef79cd8f72b8f23b815b49f4ba07ce](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/2bef79cd8f72b8f23b815b49f4ba07ce.1vz1kbhy9fa8.png)
...
![a9c35ea022a95aa76bfec990d6b73d8a](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/a9c35ea022a95aa76bfec990d6b73d8a.wwu02hai6f4.jpg)

**Nacos和CAP**

Nacos与其他注册中心特性对比

![62d5a8566a2dc588a5ed52346049a054](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/62d5a8566a2dc588a5ed52346049a054.ajlet4nj6io.png)

**Nacos服务发现实例模型**

![6578e36df056a995a39034045c36fc40](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/6578e36df056a995a39034045c36fc40.29p8fn6zdz9c.png)
...
![05d45948bf637614dbd70e2bc8ce992d](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/05d45948bf637614dbd70e2bc8ce992d.ifuz01avk3k.png)

Nacos界面配置对应 - 设置DataId

![c61619bbe5ea16f34efca8103b0f90ba](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/c61619bbe5ea16f34efca8103b0f90ba.1k5vj5ci03vk.png)

配置小结

![b3bffc4a646b30f9bf64fc649bf26f7d](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/b3bffc4a646b30f9bf64fc649bf26f7d.5cwdxcsfwvc0.png)
...
![c61619bbe5ea16f34efca8103b0f90ba](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/c61619bbe5ea16f34efca8103b0f90ba.i5856wnjisw.png)



![fe336f99f44c4b0aefddf0ae38d1c470](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/fe336f99f44c4b0aefddf0ae38d1c470.1knso1tqvy74.png)
...
![60712abd615dd86ac6c119bf132a28d6](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/60712abd615dd86ac6c119bf132a28d6.67iziumtxks0.png)
...
![b41fe36b41fa2d5abc6e5e492ee3625d](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/b41fe36b41fa2d5abc6e5e492ee3625d.6zasg6o0zas0.png)

通过spring.profile.active属性就能进行多环境下配置文件的读取



![281a70d387cb48ce82e94421adf17747](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/281a70d387cb48ce82e94421adf17747.51r5998xtxs0.png)
...
![bdf592aa566fe50f7f454118a70ca03c](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/bdf592aa566fe50f7f454118a70ca03c.cyqh30w210w.png)

在nacos图形界面控制台上面新建配置文件DatalD



![28aee2b45901bbb9a6776d5c4398a6bb](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/28aee2b45901bbb9a6776d5c4398a6bb.4kso3agae680.png)
...
![342a167a8bd948d8ba5cbfd760cf66a6](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/342a167a8bd948d8ba5cbfd760cf66a6.46h7kcgfc7s0.png)
...
![a10c71978c75c214aca5fa7057bb2834](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/a10c71978c75c214aca5fa7057bb2834.3dco0dtdnsk0.png)

回到服务管理-服务列表查看



![2a9f3fa415f5cead0219d404a47131a0](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/2a9f3fa415f5cead0219d404a47131a0.37k7ve2qv2m0.png)

按照域名配置填写



![2177c126090c0db553a8ce77e838a7c9](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/2177c126090c0db553a8ce77e838a7c9.3dd9a1foi8u0.png)
  ...
  cloud:
    nacos:
      ...
      config:
        server-addr: localhost:8848 #Nacos作为配置中心地址
        file-extension: yaml #指定yaml格式的配置
        namespace: b7d4182a-aa69-43cb-aaa8-4f8577cdd09d #<------------指定namespace
        group: DEV_GROUP
...
![59bfb9114980c13f42d14e64dd2dafab](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/59bfb9114980c13f42d14e64dd2dafab.39n8xpr1ay00.png)

上图官网翻译，真实情况



![681c3dc16a69f197896cbff482f2298e](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/681c3dc16a69f197896cbff482f2298e.5aeop8l69100.png)
...
- nacos-server-2.0.1.tar.gz 解压后安装
...
备份一下`cp nginx.conf nginx.conf.bk`

修改内容



![769472eda4b6a5e1b284db80c705d17f](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/769472eda4b6a5e1b284db80c705d17f.png)
...
![f97a514ee914fb6050fd7428beb20639](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/f97a514ee914fb6050fd7428beb20639.1j6mj049dd34.png)
...
>Sentinel 的主要特性：
>
>![e4efa9c3547366ae4f747ad4007f6447](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/e4efa9c3547366ae4f747ad4007f6447.5a7p0z4x7hc0.png)
>
...
**启动Sentinel8080 - `java -jar sentinel-dashboard-1.8.1.jar`**
...
![d8ae2bea252af0bb278332b3aeb8fb77](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/d8ae2bea252af0bb278332b3aeb8fb77.6uy8dbjyeh00.png)
...
![56642cc2b7dd5b0d1252235c84f69173](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/56642cc2b7dd5b0d1252235c84f69173.77g7o1q3imo0.png)
...
![65af4de19564cceebe7cd67589babd69](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/65af4de19564cceebe7cd67589babd69.1iuwpho3s15s.png)
...
![12cd41ae91ba50fe3b5525bab7bc3805](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/12cd41ae91ba50fe3b5525bab7bc3805.1hov4ar0em5c.png)

**Postman模拟并发密集访问testB**



![531e3c582fd2be3aa543ecca5b88c26e](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/531e3c582fd2be3aa543ecca5b88c26e.6jp902egfps0.png)

访问testB成功



![f0bdbe602b9c7185b10a2255772b3304](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/f0bdbe602b9c7185b10a2255772b3304.31axl78bg540.png)

postman里新建多线程集合组



![e66c6aef5cb47beecd7c232f6eac6686](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/e66c6aef5cb47beecd7c232f6eac6686.5ue5ur868m80.png)

将访问地址添加进新新线程组



![d476cfa823eee6589955e4762a11dfcf](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/d476cfa823eee6589955e4762a11dfcf.2ec15vtysjpc.png)
...
>
>![ede9b7e029c54840e3b40b69c4f371b5](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/ede9b7e029c54840e3b40b69c4f371b5.29u84zes71r.png)
>
...
![c26846d68d79eae1e962f37942a2c99f](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/c26846d68d79eae1e962f37942a2c99f.nplm7wbpt2o.png)
...
![0ddd217545dd0fe2b1f251dbea814ac2](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/0ddd217545dd0fe2b1f251dbea814ac2.1lz24jfo7d9c.png)
...
>
>
>![79f93ab9f5dc11b05bbed9b793ef7c20](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/79f93ab9f5dc11b05bbed9b793ef7c20.6uj6139bols0.png)
>
...
![6a002ef360a4e5f20ee2748a092f0211](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/6a002ef360a4e5f20ee2748a092f0211.4s7b5erfcwm0.png)
...
![dcf85d4362c017e543173c76b7dcc2a8](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/dcf85d4362c017e543173c76b7dcc2a8.59n7q8byzrg0.png)
...
![3a608908cef3d557322967e6bc0e5696](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/3a608908cef3d557322967e6bc0e5696.2peaeypqmtw.png)

jmeter压测

![6dcaee9f62bfd3c8334560df34f6aaa6](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/6dcaee9f62bfd3c8334560df34f6aaa6.4oqy6sv0msq0.png)
...
![b8f35b00fffd79ef68e8f744403b92f3](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/b8f35b00fffd79ef68e8f744403b92f3.2rmdc3qmale0.png)
...
![ab66591ba085c32e9303d96be7b44f0d](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/ab66591ba085c32e9303d96be7b44f0d.10aqcg1fmfkw.png)

jmeter



![6b4fd3cb04118ae77181fe8bf2019176](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/6b4fd3cb04118ae77181fe8bf2019176.1d995jk09w68.png)
...
![d92c6a9ae5ed514b52ddf43fdf0d5f0e](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/d92c6a9ae5ed514b52ddf43fdf0d5f0e.2wn5evat7o80.png)
...
![218fe52e19c07b30bbf4d994d05e6a8e](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/218fe52e19c07b30bbf4d994d05e6a8e.1um0av5ltlj4.png)
...
![9d2aa6d777767b3233aa643330eb9cf4](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/9d2aa6d777767b3233aa643330eb9cf4.3bzxdr9dd840.png)
...
>
>![16d2ddeff96b7cb68a064b6ec05bde25](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/16d2ddeff96b7cb68a064b6ec05bde25.jo9mti8pveg.png)
>
...
![9620ee4e7e54d48ba7dda394fa1c8cd0](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/9620ee4e7e54d48ba7dda394fa1c8cd0.dnudgwji1jk.png)
...
![3aa08b15109cd346a6083f080a0468fa](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/3aa08b15109cd346a6083f080a0468fa.25npd103t0lc.png)
...
![91aa0ac210011218db9557a2bfcfebd1](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/91aa0ac210011218db9557a2bfcfebd1.727ggxb6t940.png)
...
![d6a79b7cc3f2f9c8b6dcbe3f77f78c6b](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/d6a79b7cc3f2f9c8b6dcbe3f77f78c6b.6g58vwuuepc0.png)
...
![44dccf4107a74fda56f0807d39fa53f1](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/44dccf4107a74fda56f0807d39fa53f1.606ewj3ph6s0.png)
...
![2401a6b2df715ee64f647da2f31e1eeb](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/2401a6b2df715ee64f647da2f31e1eeb.14rx0y99w56k.png)
...
![c854e986254c09d0a7866811ec1e0cb4](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/c854e986254c09d0a7866811ec1e0cb4.1nuwfdry1b0g.png)

快速访问测试接口 - http://localhost:8401/rateLimit/byUrl - 页面返回`Blocked by Sentinel (flow limiting)`

停止8401再看sentinel - 停机后发现流控规则没有了

![09ea175d22d31718e15c3b569d98d381](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/09ea175d22d31718e15c3b569d98d381.70qhf3gjso40.png)
...
![9a619fb6a635ac96f2f17734bcda7967](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/9a619fb6a635ac96f2f17734bcda7967.53x4nv3vd580.png)
...
![2d2c6aa29c3158413f66d4ef8c1000dc](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/2d2c6aa29c3158413f66d4ef8c1000dc.31umj2l2gg40.png)
...
![302377d33ddcd708e20b996bd9f2c7b8](https://cdn.jsdelivr.net/gh/Wnh123/clouding@master/cloud-picture/302377d33ddcd708e20b996bd9f2c7b8.4ciiq6kqsmm0.png)
...
seata-server-1.4.1.zip解压到指定目录并修改conf目录下的file.conf配置文件
...
MySQL脚本地址：
[https://github.com/seata/seata/blob/1.4.1/script/server/db/mysql.sql](https://www.daqianduan.com/go/?url=https://github.com/seata/seata/blob/1.4.1/script/server/db/mysql.sql)

大致步骤是

1、sql准备，建表`seata`执行sql如下
...
2、配置`\seata\conf\file.conf`，我的配置如下
...
因为使用的是MySQL，所以只需配置db相关的即可

3、nacos准备，新建命名空间ID：`seata_namespace_id`，name：`seata`，描述：xxx

nacos直接操作即可

4、配置`\seata\conf\registry.conf`，我的配置如下

因为使用的都是nacos，其他都可以删除，所以简化如下，关注`namespace`的配置
...
4、启动（nacos必须先启动），有些博客写了需要在`conf`同级目录下新建`logs`存放日志，不过不知道会不会产生大影响，不放心可以加上

直接启动`seata-server.bat`即可
...
建库`seata_order`，`seata_storage`，`seata_account`
...
- http://seata.io/zh-cn/docs/user/quickstart.html 创建 UNDO_LOG 表
- 建表SQL
...
<mapper namespace="com.wnh.springcloud.dao.OrderDao">

    <resultMap id="BaseResultMap" type="com.wnh.springcloud.entities.Order">
        <id column="id" property="id" jdbcType="BIGINT"/>
...
pom、properties、yml（与seata-order-service2001模块大致相同，需要注意applicationname和seatagroup）
...
<mapper namespace="com.wnh.springcloud.dao.StorageDao">

    <resultMap id="BaseResultMap" type="com.wnh.springcloud.entities.Storage">
        <id column="id" property="id" jdbcType="BIGINT"/>
        <result column="product_id" property="productId" jdbcType="BIGINT"/>
...
<mapper namespace="com.wnh.springcloud.dao.AccountDao">

    <resultMap id="BaseResultMap" type="com.wnh.springcloud.entities.Account">
        <id column="id" property="id" jdbcType="BIGINT"/>
        <result column="user_id" property="userId" jdbcType="BIGINT"/>
...
![e639c859e870eebd847d579347ed8755](https://cdn.jsdelivr.net/gh/wnhyang/clouding@master/cloud-picture/e639c859e870eebd847d579347ed8755.sa4tga815io.png)
...
![32401b689cf9a7d624fd0f2aea7ce414](https://cdn.jsdelivr.net/gh/wnhyang/clouding@master/cloud-picture/32401b689cf9a7d624fd0f2aea7ce414.6z8174urhtc0.png)
...
![af40cc3756cef7179e58c813ed404db3](https://cdn.jsdelivr.net/gh/wnhyang/clouding@master/cloud-picture/af40cc3756cef7179e58c813ed404db3.hejj2i703s0.png)
...
![80a7bd6cacef78392b278af04d446562](https://cdn.jsdelivr.net/gh/wnhyang/clouding@master/cloud-picture/80a7bd6cacef78392b278af04d446562.6j9zkmlcl3c0.png)
...
![a16483118166481bd7f9d06f91a28146](https://cdn.jsdelivr.net/gh/wnhyang/clouding@master/cloud-picture/a16483118166481bd7f9d06f91a28146.lzgwq9yjqw0.png)
...
![828b79e4c7679ce5f09069e551c2a717](https://cdn.jsdelivr.net/gh/wnhyang/clouding@master/cloud-picture/828b79e4c7679ce5f09069e551c2a717.3l8fujg864m0.png)

补充



![21da4fdc4260008c3324574abc33f0ae](https://cdn.jsdelivr.net/gh/wnhyang/clouding@master/cloud-picture/21da4fdc4260008c3324574abc33f0ae.4nlnw3t9pzc.png)
